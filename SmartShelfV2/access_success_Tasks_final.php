	...
	if($_POST)
 {
  ...
  $conn=mysqli_connect($db_host,$db_user,$db_pass,$db_name);
		...
		if ($conn==true)
				...
				$query6="UPDATE videotips_app_access_list SET suscriptionkind = 'Vencida' where ((suscriptionpayed = 0 and suscriptiondaysleft > 365) or (suscriptionpayed = 0 and trialdaysleft > 31)) and (suscriptionkind = 'De Pago' or suscriptionkind = 'Vencida' or suscriptionkind = 'Suspendida') and username ='$local_username'"; 
