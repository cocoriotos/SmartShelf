    ...
    <div class="login-container">
        ...
        <form id="login" action="accessemailFinal.php" method="POST" autocomplete="off" onsubmit="return validateForm()">
            ...
            <div class="terms">
                ...
                <label for="terms" data-i18n="req_terms">Acepto los <a for="terms" href="TermsConditions.php" target="_blank" style="color: var(--accent); text-decoration: underline;">términos y condiciones</a></label>
            </div>
