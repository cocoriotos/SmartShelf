    ...
    <div class="login-container">
        ...
        <form id="login" action="accessemailFinal.php" method="POST" autocomplete="off" onsubmit="return validateForm()">
            ...
            <div class="terms">
                ...
                <label for="terms" data-i18n="req_terms">Acepto los <a for="terms" href="TermsConditions.php" target="_blank" class="terms-link">términos y condiciones</a></label>
            </div>
        ...
        <form id="request-access">
            ...
            <p class="contact-email-line">
                ...
                <a for="terms" href="mailto:adm@solicionespro.com" class="terms-link">adm@solicionespro.com</a>
            </p>
        </form>
        </div>
    </div>
