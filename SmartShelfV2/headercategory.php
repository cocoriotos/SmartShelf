...
<header>
  ...
  <nav class="navbar navbar-dark bg-dark d-flex justify-content-between align-items-center">
            ...
            <div class="header-action-group">
                <a id="headerfonts" href="addcategory.php" class="header-action-btn clear"><i class="fas fa-broom"></i> Limpiar Formulario</a>
                <a id="headerfonts" href="videolinkadminmodule.php" class="header-action-btn categories"><i class="fas fa-link"></i> Adicionar Enlace</a>
