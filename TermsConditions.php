...
<body id="bodyadminmodule">
  ...
  <div class="container1">
      ...
      <center><div class="col-xs-12 col-sm-12 column-custom-wrap">
          ...
          <hr>
          <center><a id="headerfonts" href="requestaccessfinal.php" class="btn btn-danger" style="background-color: #9A97F5; color: black; font-weight: bold; margin-left: 10px; margin-right: 20px; border-color: #9A97F5 ;"><i class="fa fa-reply" aria-hidden="true"></i> Página Principal</a></center>
    </div>    
  </div>
    </body>
