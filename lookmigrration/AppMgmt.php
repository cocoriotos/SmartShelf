                ...
                <div class="grid-item">
                    <div class="grid-item-content">
                        <div class="grid-item-header">
                            ...
                            <p class="p-title"><span class="left-text"> 1 Mes:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="<?php echo (($monthsuscriptions == 1)  ? 'red' : ($monthsuscriptions >= 2 && $monthsuscriptions <= 3) ? 'orange' : ($monthsuscriptions >= 3 && $monthsuscriptions <= 10) ? 'orange' : ($monthsuscriptions == 11 ? 'green' : '')); ?>"><?php echo $monthsuscriptions; ?></span></span></p>
