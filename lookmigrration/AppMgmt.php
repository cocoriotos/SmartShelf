...
$query18 = "UPDATE u927778197_appsdb.videotips_app_access_list a JOIN (SELECT username, COUNT(*) AS link_count FROM u927778197_appsdb.videotips_videotips GROUP BY username) v ON a.username = v.username SET a.linksquantity = v.link_count";
