                ...
                <div class="grid-item">
                    <div class="grid-item-content">
                        <div class="grid-item-header">
                            ...
                            <p class="p-title"><span class="left-text"> 5 Meses:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="<?php echo ($fivesuscriptions < 8) ? 'green' : (($fivesuscriptionss >= 9 && $fivesuscriptionsns <= 10) ? 'orange' : ($fivesuscriptionsons == 11 ? 'red' : '')); ?>"><?php echo $fivesuscriptionsions; ?></span></span></p>
